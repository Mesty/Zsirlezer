// Alapjel meredekseg korlatja [m/s^2]
...
// Szabalyozas
if(alapjel - elozo_alapjel > ALAPJEL_MEREDEKSEG_GYORSITASNAL)
	alapjel = elozo_alapjel + ALAPJEL_MEREDEKSEG_GYORSITASNAL;
else if(elozo_alapjel - alapjel > ALAPJEL_MEREDEKSEG_LASSITASNAL)
	alapjel = elozo_alapjel - ALAPJEL_MEREDEKSEG_LASSITASNAL;
pozitiv_visszacsatolas = 0.99288*pozitiv_visszacsatolas+0.0071168*elozo_beavatkozo_jel;
FOXBORO_bemeno_jel = 0.72413*(alapjel-velocity)+pozitiv_visszacsatolas;
